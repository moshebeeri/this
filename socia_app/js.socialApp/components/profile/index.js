...
import { Container, Header, Content, Text, Button, Icon, InputGroup, Input, Thumbnail, Grid, Col } from 'native-base';
  ...
  render() {
    return (
      <Container theme={theme}>
          ...
          <View style={styles.header} >
            <View style={styles.rowHeader}>
              ...
              <InputGroup style={styles.search}>
                ...
                <Input placeholder="Aditya Thakur" style={styles.searchBox} />
              </InputGroup>
        ...
        <Content style={{ backgroundColor: '#fff', paddingBottom: 50 }}>
              ...
              <View style={styles.imgContainer}>
                ...
                <TouchableOpacity>
                  <View style={styles.editBlock}>
                    <Icon name="ios-videocam" style={styles.editCam} />
          ...
          <View style={styles.commentContainer}>
            <View style={{flexDirection: 'row'}}>
              <Icon name={'ios-thumbs-up'} style={styles.thumb} />
              <Text style={{color: 'rgba(0,0,0,0.4)', marginTop: 15, marginLeft: 10}}>Suraj and 48 others</Text>
            </View>
            <Text style={{color: 'rgba(0,0,0,0.4)', marginTop: 15, marginLeft: 10}}>3 Comments</Text>
          </View>

          <Grid style={{paddingHorizontal: 10, paddingVertical: 13, borderBottomWidth: 1, borderBottomColor: 'rgba(0,0,0,0.3)', marginBottom: Platform.OS === 'ios' ? undefined : 50}}>
