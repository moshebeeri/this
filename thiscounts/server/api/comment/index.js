...
router.post('/group/chat/:group/:from/:scroll', auth.isAuthenticated(), controller.scroll);
router.post('/find/:skip/:limit', auth.isAuthenticated(), controller.find);
router.post('/group/chat_old/:group/:skip/:limit', auth.isAuthenticated(), controller.group_chat);
