...
router.post('/create', auth.isAuthenticated(), controller.createUploadVideo);
router.post('/create/youtube/:youtube', auth.isAuthenticated(), controller.createYouTubeVideo);
