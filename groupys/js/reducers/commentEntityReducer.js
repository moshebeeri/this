 ...
 */
const initialState = {entityComments:{},entityCommentsOrder:{},clientMessages:{},loadingDone:{},showTopLoader:{},update:false,lastCall:{}};
    ...
    switch (action.type) {
        ...
        case actions.UPSERT_ENTITIES_COMMENT :
            ...
            if(! currentState.entityCommentsOrder[action.generalId]){
                currentState.entityCommentsOrder[action.generalId] = new Array();
            }
        ...
        case actions.ENTITIES_COMMENT_INSTANCE_ADD_MESSAGE:
            if( !clientMessage[action.generalId]){
                clientMessage[action.generalId] = new Array();
            }
