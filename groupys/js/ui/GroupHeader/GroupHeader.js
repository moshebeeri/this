...
export default class GroupHeader extends Component {
    ...
    createIcon(groupType) {
        switch (groupType) {
            case 'BUSINESS':
                return <ImageController style={{width:17, height:16 }} source={require('../../../images/busiicon.png')}/>
            case 'USERS':
                return <ImageController style={{width:16, height:16 }} source={require('../../../images/publicicon.png')}/>
        }
    }
        ...
        return <TouchableOpacity onPress={onPressAction} disabled={disabled} style={containerStyle}>
            <View style={[styles.groupHeader, {width: StyleUtils.getWidth()}]}>
                ...
                <View style={styles.groupName}>
                    ...
                    <View style={{flexDirection: 'row',  flex: 5, marginTop:8,
