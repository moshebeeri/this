...
import { Container, Content, Text, InputGroup, Input, Button,Picker,Item, Icon,Header,Footer, View } from 'native-base';
        ...
        return (
            <Container>
                ...
                <Content  style={{backgroundColor: '#fff'}}>
                    ...
                    <Item underline>
                        <Input  multiline  style={{ height: 300}}  onChangeText={(json) => this.setState({json})} placeholder='Request' />
                    </Item>
