...
class EditPromotion extends Component {
    ...
    addToList(responseData){
        let businessId = this.props.navigation.state.params.item.entity.business._id;
            ...
            <Container>
                ...
                <Content style={{margin:10,backgroundColor: '#fff'}}>
                    ...
                    <View style={{margin:10,borderWidth:3,borderRadius:10, backgroundColor: '#fff'}}>
                        ...
                        <Text style ={{marginLeft:5}}>You can increase the quantity of promotions Or extend the due date</Text>

                        <Item  style={{ margin:3 } } regular>
                            <Input  blurOnSubmit={true} returnKeyType='next' ref="1" onSubmitEditing={this.focusNextField.bind(this,"2")} value={this.state.item.name} onChangeText={(name) => this.setState({name})}
                                    placeholder='Name'/>
                        </Item>
                        <Item  style={{ margin:3 } } regular>
                        ...
                        <Item  style={{ margin:3 } } regular>
                            <Input keyboardType = 'numeric'   value={this.state.quantity}  onChangeText={(value) => this.setQuantity(value)} placeholder='Increase Quantity' />
                        </Item>
                        {errorMessage}
