...
export class MyCameraService {
  ...
  constructor(private storage: Storage/*, public nav: NavController*/, private platform: Platform, private globalHeaders:GlobalHeaders, private deviceService: DeviceService, private globals: GlobalsService, private ngZone: NgZone) {
    this.local = storage;
